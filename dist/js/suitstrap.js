/*!
 * Suitstrap 0.1.0 by @vanhoofmaarten
 *
 * Copyright 2014 @vanhoofmaarten
...
+ function($) {
	...
	Carousel.prototype.slide = function(type, next) {
		...
		if ($next.hasClass('is-active')) return
...
+ function($) {
	...
	function clearMenus() {
		...
		$(toggle).each(function(e) {
			...
			if (e.isDefaultPrevented()) return
			$parent.removeClass('is-open').trigger('hidden.bs.dropdown')
		})
	}
