...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/vanhoofmaarten/suitstrap.git
   ```
...
<!-- [(Almost) adhere to the Code Guide.](http://codeguide.co/#html)
@mdo uses 2 spaces for indentation, Suitstrap is build with tab-indentation with a size of 4 spaces, for increased readability. -->
